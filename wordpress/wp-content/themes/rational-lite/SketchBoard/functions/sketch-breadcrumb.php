...
class rational_lite_breadcumb_class {

    var $opts;

    function rational_lite_custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'rational-lite') . '</a>';
        ...
        $output = $this->rational_lite_simple_breadcrumb_case($post);
    ...
    function rational_lite_simple_breadcrumb_case($der_post) {
        ...
        if (is_page()) {
            ...
            if ($der_post->post_parent) {
                ...
                $this->rational_lite_simple_breadcrumb_case($my_query);
        ...
        if (is_author()) {
            ...
            return __('Author', 'rational-lite') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'rational-lite') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'rational-lite');

        }

		if (is_404()) {            return __('Error 404', 'rational-lite');        }
...
$rational_lite_breadcumb = new rational_lite_breadcumb_class();
