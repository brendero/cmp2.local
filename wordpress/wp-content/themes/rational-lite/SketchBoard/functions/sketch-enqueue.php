...
function rational_lite_theme_stylesheet()
{
	...
	wp_enqueue_script('cbpAnimatedHeader', get_template_directory_uri().'/js/cbpAnimatedHeader.js', array('jquery'), '1.0', true);
	wp_enqueue_script('easing', get_template_directory_uri().'/js/jquery.easing.1.3.js', array('jquery'),'1.3', true);
	wp_enqueue_script('waypoints', get_template_directory_uri().'/js/waypoints.js', array('jquery'), '2.0.2', true);
	
	wp_enqueue_style('rational-style', get_stylesheet_uri(), false, $theme->Version);
	wp_enqueue_style('animation-stylesheet', get_template_directory_uri().'/css/skt-animation.css', array(), $theme->Version);
	wp_enqueue_style('font-awesome', get_template_directory_uri().'/css/font-awesome.css', array(), '4.5');
	
	/*SUPERFISH*/
	wp_enqueue_style('superfish', get_template_directory_uri().'/css/superfish.css', array(), $theme->Version);
	wp_enqueue_style('bootstrap-responsive', get_template_directory_uri().'/css/bootstrap-responsive.css', array(), $theme->Version);
	...
	if($is_IE ) {
		wp_enqueue_style('ie-style', get_template_directory_uri().'/css/ie-style.css', array(), $theme->Version  );
		wp_enqueue_style('font-awesome-ie7', get_template_directory_uri().'/css/font-awesome-ie7.css', array(), $theme->Version );
	}
