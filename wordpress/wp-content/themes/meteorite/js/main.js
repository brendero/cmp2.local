...
;(function($) {
	...
	var meteorite_projectsTypeRevealTitle = function() {
		// Fix for multiple row title for project type 'reveal title'
		if ( $(".project-type-reveal-title").length ) {
			$(".project-type-reveal-title .project-title-wrap").each(function() {
				var titleHeight = $(this).outerHeight();
				$(this).css({ 'bottom' : - titleHeight + "px" });
			});
		}
	};
	...
	$(function() {
		...
		meteorite_projectsTypeRevealTitle();
