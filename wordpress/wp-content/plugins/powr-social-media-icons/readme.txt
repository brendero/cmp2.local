...
Tags: social media, icons, buttons, Facebook, Twitter, Instagram, LinkedIn, YouTube, email, profile, google plus, RSS
...
Social Icons let you send visitors to any social account: Facebook, Instagram, Twitter, Tumblr, YouTube, Reddit, LinkedIn, Pinterest, RSS, Yelp, etc.

== Description ==
[youtube https://www.youtube.com/watch?v=OdUHShj0NpA] Grow your social media following with linked icons
<br>
<br>
...
<br>
<br>
First, download, install, and activate POWr Social Media Icons. Then drop the plugin anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-social-media-icons-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
<br>
= Free Features =
* Link up to 5 accounts.
* Supports Facebook, Twitter, Instagram, LinkedIn, Pinterest, YouTube, Yelp, Google+, Flickr, Tumblr, FourSquare, GitHub, and more!
...
= <a href='https://www.powr.io/plugins/social-media-icons'>More Info</a> =
<br>

= LIVE EDITING =
POWr Social Media Icons plugin is simple to customize, directly inside of your live WordPress website. Just click on the Settings Icon to open the POWr Editor. You can now edit the design and contents of your Social Media Icons plugin. See your changes in real time, on your actual site. No need to ever leave the page. Just edit and save right in the POWr Editor.
<br>
= MOBILE RESPONSIVE =
...
= How do I add Social Media Icons to a page or blog post? =
...
= How do I add Social Media Icons to a theme? =
In your WP Dashboard, select Appearance > Widgets from the left sidebar. Find Social Media Icons under Available Widgets and drag it into a sidebar or footer.  Then visit the live page to set up the plugin.

= Can I add more than one Social Media Icons? =
Yes, absolutely!  To clone an existing Social Media Icons, paste the exact same unique shortcode into another page or post.  To create a new version, select Social Media Icons from the sidebar in your WP Dashboard and click Create New.  You can then edit and save a new version, and paste the new unique shortcode into a page or post.

= Will my users see the Edit button above Social Media Icons? =
